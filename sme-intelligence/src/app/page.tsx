    ...
    <main className="bg-paper text-ink">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-10 pb-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="rounded-xl2 border border-forest-900/10 bg-white shadow-[0_20px_60px_-20px_rgba(15,42,30,0.25)] overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-2 gap-4">
            <MockKpi label="Revenue" value="₦12.45M" change="+12.4%" positive />
            <MockKpi label="Gross Profit" value="₦4.25M" change="+8.1%" positive />
            <MockKpi label="Expenses" value="₦8.20M" change="+3.2%" positive={false} />
      ...
      <section id="features" className="bg-forest-50/60 py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            ...
            <FeatureCard title="Naira-native" text="₦ currency, all 36 states + FCT, and business categories that match Nigerian retail — not a US template." />
      ...
      <section id="pricing" className="bg-forest-900 text-paper py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-12 grid md:grid-cols-4 gap-5">
            <PricingCard plan="Free" price="₦0" features={['1 business', 'Limited uploads/month', 'Core dashboard', 'Basic reports']} />
            <PricingCard plan="Business" price="₦15,000/mo" features={['Unlimited uploads', 'Forecasting', 'AI Assistant', 'Advanced analytics']} highlighted />
            <PricingCard plan="Professional" price="₦35,000/mo" features={['Multiple branches', 'Automated reports', 'Alerts & notifications', 'Priority support']} />
      ...
      <footer className="border-t border-forest-900/10 py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-4 text-sm text-ink/50">
          <span>© {new Date().getFullYear()} SME Intelligence. Built for Nigerian businesses.</span>
